...
class Physics(mujoco.Physics):
    """Physics simulation with additional features for the Humanoid domain."""

    def torso_upright(self) -> np.float64:
        """Returns projection from z-axes of torso to the z-axes of world."""
        return self.named.data.xmat["torso", "zz"]

    def head_height(self) -> np.float64:
        """Returns the height of the torso."""
        return self.named.data.xpos["head", "z"]

    def center_of_mass_position(self) -> np.ndarray:
    ...
    def torso_vertical_orientation(self) -> np.ndarray:
    ...
    def extremities(self) -> np.ndarray:
